...
# <a name="how-to-set-up-service-offerings"></a>Fremgangsmåde: Definere servicetilbud
...
|**Hvis du vil**|**Se**|  
|------------|-------------|  
|Angive oplysninger om de serviceartikler, serviceorganisationen sporer.|[Sådan gør du: Oprette serviceartikler](service-how-to-create-service-items.md)|  
|Definere en proces for service, når serviceartiklerne består af flere komponenter. Komponentlisten er altid knyttet til en serviceartikel, men disse komponenter kan også være baseret på styklister.|[Fremgangsmåde: Konfigurere serviceartikler og serviceartikelkomponenter](service-how-setup-service-items.md)|  
