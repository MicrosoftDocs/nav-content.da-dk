...
description: Du kan afstemme bankkonti i Dynamics NAV med kontoudtog fra banken.
documentationcenter: 
author: SorenGP
...
Felter i oversigtspanelet **Overførsel** i vinduet **Bankkontokort** er relateret til indlæsning og udlæsning af bankfeeds og -filer. Du kan finde flere oplysninger under [Fremgangsmåde: Konfigurere tjenesten til konvertering af bankdata](bank-how-setup-bank-data-conversion-service.md).
