---
title: Dynamics NAV og Power BI-indholdspakker
description: "Du kan nemt få indsigt, business intelligence og nøgletal i dine Dynamics NAV-data med Power BI og Dynamics NAV-indholdspakker."
author: edupont04
...
| App | Description |
| --- | --- |
| Microsoft Dynamics NAV | Indeholder et dashboard med de vigtigste finansielle data over en periode, f.eks. indtægter og udgifter, driftsavance og kassebeholdningsproces.|
| Microsoft Dynamics 365 for Sales | Indeholder et dashboard med vigtige oplysninger om salgsmuligheder og kontakter.  |
| Microsoft Dynamics 365 for Sales | Indeholder et dashboard med vigtige oplysninger om salg og lager. |
...
* Adgang til [!INCLUDE[d365fin](includes/d365fin_md.md)]. Du kan finde flere oplysninger i [Dynamics NAV](http://go.microsoft.com/fwlink/?LinkID=759714).  
