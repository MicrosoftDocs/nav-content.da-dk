...
description: "Du kan gøre dine Dynamics NAV-data tilgængelige som en datakilde i Power BI og opbygge nyttige rapporter over status for din virksomhed."
author: edupont04
...
2. I vinduet **Hent data** skal du vælge **Onlinetjenester**, vælge **Dynamics NAV** og derefter vælge knappen **Opret forbindelse**.
...
Når dataene er indlæst, vises de i den rigtige navigation på siden. Nu har du oprettet forbindelse til dine Dynamics NAV-data og er klar til at opbygge din Power BI-rapport. Du kan finde flere oplysninger i [Power BI-dokumentationen](https://powerbi.microsoft.com/documentation/powerbi-landing-page/).
